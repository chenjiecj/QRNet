...
from utilsYOLO.utils_bbox import dist2bbox, make_anchors
...
def get_lr_schedulerYOLO(lr_decay_type, lr, min_lr, total_iters, warmup_iters_ratio = 0.05, warmup_lr_ratio = 0.1, no_aug_iter_ratio = 0.05, step_num = 10):
...
def set_optimizer_lrYOLO(optimizer, lr_scheduler_func, epoch):
